...
export const aiArticles = [
  ...
  },
  {
    ...
    "toc": [
      ...
      {
        "id": "ai-optimization-patterns-pad-0",
        "text": "AI Model Query and Optimization Patterns (Section 1)"
      },
      {
        "id": "ai-safety-governance-pad-1",
        "text": "Safety Boundaries and Governance in AI Nodes (Section 2)"
      }
    ],
    "content": [
      {
