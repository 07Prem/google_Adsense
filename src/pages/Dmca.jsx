  ...
  return (
    <>
      <SEOHead 
        ...
        description="Read the TechAxioz DMCA Policy. Learn how to report copyright infringements or submit counter-notices."
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10">
        ...
        <div className="max-w-3xl mx-auto py-8">
          ...
          <div className="prose dark:prose-invert text-slate-700 dark:text-slate-350 space-y-6 font-sans text-sm sm:text-base leading-relaxed">
            <p>
              TechAxioz respects the intellectual property rights of others. In accordance with the Digital Millennium Copyright Act (DMCA), we will respond quickly to claims of copyright infringement committed using our website that are reported to our designated copyright agent.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Identification of the material that is claimed to be infringing (including the specific URL link on TechAxioz).</li>
              <li>Your contact information including email address, mailing address, and telephone number.</li>
              <li>A statement that you have a good faith belief that use of the material is not authorized by the copyright owner.</li>
            </ul>
            <p>
              Please send DMCA notices directly to support@techaxioz.com.
            </p>
          </div>
        </div>
      </div>
